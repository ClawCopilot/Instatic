...
- Use `ghcr.io/clawcopilot/instatic:latest` when you want the service to redeploy whenever the `latest` tag moves.
- Use a semver tag like `ghcr.io/clawcopilot/instatic:0.0.10` when you want Railway to stage matching patch or minor updates according to the service's auto-update preference.
